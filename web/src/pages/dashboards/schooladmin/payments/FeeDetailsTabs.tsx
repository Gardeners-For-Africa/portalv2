...
import { mockClasses, mockPayments, mockStudents } from "@/utils/mockData";
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {formatCurrency(stats.paidAmount, fee.currency)}
                    </div>
                  </CardContent>
                </Card>
              </div>
                            ...
                            <TableCell>
                              <div className="flex items-center space-x-3">
                                <Avatar className="h-8 w-8">
                                  <AvatarImage
                                    src={
                                      mockStudents.find((s) => s.id === payment.studentId)?.avatar
                                    }
                                  />
                                  <AvatarFallback>
                                    {payment.studentName
                              ...
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  ...
                                  <DropdownMenuItem
                                    onClick={() =>
                                      navigate(
                                        `/dashboard/school-admin/payments/edit/${payment.id}`,
                                      )
                                    }
                                  >
