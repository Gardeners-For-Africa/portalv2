...
export default function TeacherDashboard() {
  ...
  const getEventTypeBadge = (type: string) => {
    ...
    return (
      <Badge className={config.className}>{type.charAt(0).toUpperCase() + type.slice(1)}</Badge>
    );
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Across {mockClasses.length} classes</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Physics - 2:00 PM</p>
          </CardContent>
        </Card>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your assigned classes and their current status</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {mockClasses.map((cls) => (
                  <div key={cls.id} className="p-4 border rounded-lg">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-xs text-gray-500">{cls.recentActivity}</div>
                    </div>
                  </div>
                ))}
              </div>
                ...
                {upcomingEvents.map((event) => (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <div className="text-right">{getEventTypeBadge(event.type)}</div>
                    </div>
                  </div>
                ))}
              </div>
