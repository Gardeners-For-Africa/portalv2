      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            />
            <Route
              path="/dashboard/super-admin/schools/new"
              element={
                <RoleLayout allowedRoles={["super_admin"]} requireAuth={true}>
                  <SchoolForm />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/super-admin/schools/edit/:id"
              element={
                <RoleLayout allowedRoles={["super_admin"]} requireAuth={true}>
                  <SchoolForm />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/super-admin/schools/:id"
              element={
                <RoleLayout allowedRoles={["super_admin"]} requireAuth={true}>
                  <SchoolDetails />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/users/students"
              element={
            ...
            />
            <Route
              path="/dashboard/school-admin/users/teachers"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <Teachers />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/super-admin/users/new"
              element={
                <RoleLayout allowedRoles={["super_admin"]} requireAuth={true}>
                  <UserForm />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/super-admin/users/edit/:id"
              element={
                <RoleLayout allowedRoles={["super_admin"]} requireAuth={true}>
                  <UserForm />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/super-admin/users/:id"
              element={
                <RoleLayout allowedRoles={["super_admin"]} requireAuth={true}>
                  <UserDetails />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/super-admin/notifications/new"
              element={
                <RoleLayout allowedRoles={["super_admin"]} requireAuth={true}>
                  <NotificationForm />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/super-admin/notifications/:id"
              element={
                <RoleLayout allowedRoles={["super_admin"]} requireAuth={true}>
                  <NotificationDetails />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/super-admin/settings/edit"
              element={
                <RoleLayout allowedRoles={["super_admin"]} requireAuth={true}>
                  <SettingsForm />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/classes/new"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <ClassForm />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/classes/edit/:id"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <ClassForm />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/classes/:id"
              element={
                <RoleLayout allowedRoles={["school_admin", "teacher"]} requireAuth={true}>
                  <ClassDetails />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/students/edit/:id"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <StudentForm />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/students/promote"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <StudentPromotion />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/students/graduate"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <StudentGraduation />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/students/table"
              element={
                <RoleLayout allowedRoles={["school_admin", "teacher"]} requireAuth={true}>
                  <StudentsTable />
                </RoleLayout>
            ...
            <Route
              path="/dashboard/school-admin/subjects"
              element={
                <RoleLayout allowedRoles={["school_admin", "teacher"]} requireAuth={true}>
                  <SubjectsList />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/subjects/new"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <SubjectForm />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/subjects/edit/:id"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <SubjectForm />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/subjects/assignments"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <SubjectAssignments />
                </RoleLayout>
            ...
            <Route
              path="/dashboard/school-admin/payments"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <PaymentsList />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/payments/fees"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <FeesList />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/payments/fees/new"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <FeeForm />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/payments/fees/edit/:id"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <FeeForm />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/payments/fees/:id"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <FeeDetails />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/payments/:id"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <PaymentDetails />
                </RoleLayout>
            ...
            <Route
              path="/dashboard/school-admin/grading/settings"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <GradingSettings />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/grading/exams"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <Exams />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/grading/scores"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <Scores />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/grading/bulk-updates"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <BulkUpdates />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/grading/termly-results"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <TermlyResultsTable />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/grading/annual-results"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <AnnualResultsTable />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/grading/dashboard"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <GradingDashboard />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/grading/results/:id"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
            ...
            />
            <Route
              path="/dashboard/school-admin/grading/annual/:studentId/:academicYear"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
            ...
            />
            <Route
              path="/dashboard/school-admin/grading/termly-cards"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <TermlyResults />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/school-admin/grading/annual-cards"
              element={
                <RoleLayout allowedRoles={["school_admin"]} requireAuth={true}>
                  <AnnualResults />
                </RoleLayout>
            ...
            <Route
              path="/dashboard/teacher/grades/scores"
              element={
                <RoleLayout allowedRoles={["teacher"]} requireAuth={true}>
                  <TeacherScores />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/teacher/grades/bulk-update"
              element={
                <RoleLayout allowedRoles={["teacher"]} requireAuth={true}>
                  <TeacherBulkUpdate />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/teacher/grades/results"
              element={
                <RoleLayout allowedRoles={["teacher"]} requireAuth={true}>
                  <TeacherResults />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/teacher/grades/student-results/:studentId"
              element={
                <RoleLayout allowedRoles={["teacher"]} requireAuth={true}>
            ...
            {/* Score Entry Route */}
            <Route
              path="/dashboard/teacher/grades/score-entry/:studentId"
              element={
                <RoleLayout allowedRoles={["teacher"]} requireAuth={true}>
                  <TeacherScoreEntry />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/teacher/payments/student/:studentId"
              element={
                <RoleLayout allowedRoles={["teacher"]} requireAuth={true}>
                  <StudentPaymentDetails />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/teacher/payments/invoice/:studentId"
              element={
                <RoleLayout allowedRoles={["teacher"]} requireAuth={true}>
                  <InvoiceGenerator />
                </RoleLayout>
            ...
            />
            <Route
              path="/dashboard/teacher/payments/reports"
              element={
                <RoleLayout allowedRoles={["teacher"]} requireAuth={true}>
                  <PaymentReports />
                </RoleLayout>
